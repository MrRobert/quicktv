<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/quicktv/zadmin/');
define('HTTP_CATALOG', 'http://localhost/quicktv/');
define('STATIC_PATH', 'D:/xampp/htdocs/quicktv');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/quicktv/zadmin/');
define('HTTPS_CATALOG', 'http://localhost/quicktv/');
