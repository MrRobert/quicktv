              ...
              <div class="tab-content">
                <div class="tab-pane" id="language1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="category_description[1][description]" placeholder="<?php echo $entry_description; ?>" id="input-description1" class="form-control"><?php echo isset($category_description[1]) ? $category_description[1]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php if($type == 'canhac') { ?>
                            <select name="type" class="form-control">
                                <option value="clip">Clip</option>
                                <option value="movie">Movie</option>
                                <option value="canhac" selected="selected">Ca Nhạc</option>
                            </select>
                        <?php }?>
                        <?php if($type != 'canhac' && $type != 'clip' && $type != 'movie') { ?>
                            <select name="type" class="form-control">
                                <option value="clip">Clip</option>
                                <option value="movie">Movie</option>
                                <option value="canhac">Ca Nhạc</option>
