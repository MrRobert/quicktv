...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['category_clip'] = $this->url->link('catalog/category', 'type=clip&' .'token=' . $this->session->data['token'], 'SSL');
        $data['category_movie'] = $this->url->link('catalog/category', 'type=movie&'. 'token=' . $this->session->data['token'], 'SSL');
        $data['category_canhac'] = $this->url->link('catalog/category', 'type=canhac&'.'token=' . $this->session->data['token'], 'SSL');
