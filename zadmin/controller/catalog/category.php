...
class ControllerCatalogCategory extends Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            if(isset($this->request->post['type'])){
                $orgin_type = $this->request->post['type'];
            }
            if (isset($this->request->get['type'])) {
                $orgin_type = $this->request->get['type'];
            }
            ...
            $this->response->redirect($this->url->link('catalog/category', 'type='. $orgin_type .'&token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            'text' => $type,
            'href' => $this->url->link('catalog/category', 'type='. $orgin_type .'&token=' . $this->session->data['token'] . $url, 'SSL')
        );
        ...
        $category_total = $this->model_catalog_category->getTotalCategories($orgin_type);
        ...
        foreach ($results as $result) {
            $data['categories'][] = array(
                ...
                'edit'        => $this->url->link('catalog/category/edit', 'type='. $orgin_type . '&token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, 'SSL'),
                'delete'      => $this->url->link('catalog/category/delete', 'token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, 'SSL')
            );
        }

        $data['heading_title'] = $type;
